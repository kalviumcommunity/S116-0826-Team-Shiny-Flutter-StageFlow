          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  '${AppDateUtils.formatDayOfWeek(event.start)}, ${AppDateUtils.formatDate(event.start)} • ${AppDateUtils.formatTimeRange(event.start, event.end)}',
                  style: TextStyle(
                    fontSize: 13,
            ...
            if (event.castIds.isNotEmpty) ...[
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 6),
                  Text(
                    '${event.castIds.length} cast member${event.castIds.length == 1 ? '' : 's'} called',
                    style: TextStyle(
                      fontSize: 12,
                      color: theme.colorScheme.onSurfaceVariant,
